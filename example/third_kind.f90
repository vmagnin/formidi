...
program third_kind
    ...
    call midi%play_note(channel=0_int8, note=MIDI_Note("G4"), velocity=64_int8, value=quarter_note)
    call midi%play_note(channel=0_int8, note=MIDI_Note("A4"), velocity=64_int8, value=quarter_note)
    call midi%play_note(channel=0_int8, note=MIDI_Note("F4"), velocity=64_int8, value=quarter_note)
    call midi%play_note(channel=0_int8, note=MIDI_Note("F3"), velocity=64_int8, value=quarter_note)
    call midi%play_note(channel=0_int8, note=MIDI_Note("C4"), velocity=64_int8, value=2*quarter_note)
